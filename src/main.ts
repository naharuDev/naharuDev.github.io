...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  ...
  <div class="bg-emerald-300 bg-opacity-10 z-20 overflow-hidden relative">
    <div class="w-40 h-40 rounded-full bg-emerald-100 opacity-40 object-center m-10 absolute filter blur-3xl -z-10 animate-bounce"></div> 
    ...
    <section class ="px-10 py-20">
      <div class="bg-emerald-50 h-1 sm:m-2 rounded-sm "></div>
      <h1 class = "p-10 text-4xl">Animation</h1>
      <div class ="bg-lime-50 bg-opacity-20 h-10 "></div>
    </section>

    <section class ="px-10 py-20">
      <div class="bg-emerald-50 h-1 sm:m-2 rounded-sm "></div>
      <h1 class = "p-10 text-4xl">Painting</h1>
      <div class ="bg-lime-50 bg-opacity-20 h-10 "></div>
    </section>

    <section class ="px-10 py-20 ">
      <div class="bg-emerald-50 h-1 sm:m-2 rounded-sm "></div>
      <h1 class = "p-10 text-4xl">Game Development</h1>
      <div class ="bg-lime-50 bg-opacity-20 h-10 "></div>
    </section>
